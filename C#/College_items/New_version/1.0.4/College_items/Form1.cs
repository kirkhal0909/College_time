...
namespace College_items
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "oborudovanieDataSet.Сотрудники_Запрос". При необходимости она может быть перемещена или удалена.
            this.сотрудники_ЗапросTableAdapter.Fill(this.oborudovanieDataSet.Сотрудники_Запрос);                        
