...
echo '<div class="data-form">
	<form method="post" action="/php/options_save.php">
		<!--<input class="input-field" value="'.$user->teacher->getPhone().'" placeholder="Телефон" type="text" name="phone"><br>
		<input class="input-field" value="'.$user->teacher->getEmail().'" placeholder="E-mail@mail.dom" type="text" name="email"><br>
		'.$birthOptions.'		    -->
	    <input class="input-field" placeholder="Новый пароль" type="password" name="pass-new"><br>
